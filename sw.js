...
self.addEventListener('fetch', (event) => {
  ...
  // Page navigations: network first, fall back to cached app shell (works offline).
  ...
  // Third-party CDNs (Tailwind, fonts, icons, PDF libs, Quran API): stale-while-revalidate.
